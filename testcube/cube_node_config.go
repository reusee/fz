...
type CubeConfig = *config.Config

func (_ CubeNodeScope) CubeConfg(
	id CubeNodeID,
	tap TapCubeConfig,
...
type TapCubeConfig func(CubeConfig)

var _ dscope.Reducer = TapCubeConfig(nil)

func (_ TapCubeConfig) Reduce(_ Scope, vs []reflect.Value) reflect.Value {
	return dscope.Reduce(vs)
}

func (_ CubeNodeScope) TapCubeConfig() TapCubeConfig {
	return func(_ CubeConfig) {
	}
}
